# 🔐 Project Title Multiformat Encoder and Decoder 
...
```
Project/
├── multiformat encoder and decoder.html
```
...
- Encode / decode: Base64, Base32, URL, HTML, Hex, Binary
- Auto-detect encoding type from input
- Chain multiple encodings (e.g. Base64 → URL)
- Decode XOR-obfuscated strings with key
...
Name: Vallari Narendra Awale 
Enrollment no:24313270017
Branch:-CM
